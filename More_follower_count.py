...
while continue_game:
    ...
    user_guess=input('Chose between A or B'.lower())
    ...
    # Ask user for a guess.
        ...
        # Check if user is correct    ## Get follower count.
...
Make a new file with .py extention and save this data below
